...
data class Transaction(
    ...
    val initiator: Delegate? = null,
    val sender: Delegate? = null,
    val senderCodeHash: Int? = null,
    val nonce: Int? = null,
    val gasLimit: Int? = null,
    val gasUsed: Int? = null,
    val storageLimit: Int? = null,
    val storageUsed: Int? = null,
    val bakerFee: Int? = null,
    val storageFee: Int? = null,
    val allocationFee: Int? = null,
    val target: Delegate? = null,
    val targetCodeHash: Int? = null,
    val amount: Int? = null,
    val parameter: Parameter? = null,
    val storage: String? = null,
    val diffs: List<Diff>? = null,
    val status: String? = null,
    val errors: List<Error>? = null,
    val hasInternals: Boolean? = null,
    val tokenTransfersCount: Int? = null,
    val ticketTransfersCount: Int? = null,
